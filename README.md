# DCF Financial Model & Valuation Analysis
**Python-powered financial forecasting and Discounted Cash Flow (DCF) valuation model.** 
- Analyzes historical data, projects selected years forward, and delivers intrinsic value per share with margin of safety integrated

## Notes: 
- Currently only an infant student project - Other important features of a effective DCF Model are not integrated yet.
- Inputs currently must be edited into the code, Input system will be added in the future.
- Assumptions are automatically built in, and are editable
...
## 🚀 Quick Start
1. **Edit historical data** (lines 2-7) with your company numbers
2. **Run all cells** 
3. **Get instant valuation + financial health report**
